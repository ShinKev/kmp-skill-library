...
> This skill applies only to Android (`:androidApp` or `androidMain`). It is not applicable to KMP shared code (`commonMain`) or iOS. For iOS accessibility, refer to Apple's Accessibility documentation and VoiceOver guidelines.
