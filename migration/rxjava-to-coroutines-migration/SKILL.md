...
> RxJava is an Android/JVM library. This migration skill applies to Android codebases. New KMP shared code should use Kotlin Coroutines and Flow directly from the start.
